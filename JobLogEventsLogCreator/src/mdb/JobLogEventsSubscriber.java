    ...
    public void onMessage(Message msg) {
        try {
            ...
            if (destination.equalsIgnoreCase("topic://batch/jobs/execution/jobLogPart")) {
                ...
                String basePath = "JobLogEvents\\" + appName + "\\" + currentDate + "\\instance." + instanceID + "\\execution." + execID;
                ...
                if (jobLogEventObject.containsKey("partitionNumber")) {
                    ...
                    logDirectory = new File(basePath + "\\" + stepName + "\\" + partitionNum);
                }
                //If a flow name exists then there will be a split name as well
                    ...
                    logDirectory = new File(basePath + "\\" + splitName + "\\" + flowName);
                }
                ...
                if (logDirectory != null && directoryExistsOrIsCreated) {
                    try {
                        PrintWriter out = new PrintWriter(logDirectory.getAbsolutePath() + "\\part" + partNumber + ".log");
